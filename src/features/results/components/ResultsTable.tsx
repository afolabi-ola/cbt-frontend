...
const getScoreClass = (score: number | null | 'unrealesed', status: string) => {
  if (score === null || score === undefined || score === 'unrealesed') {
            ...
            results.map((result, idx) => (
              ...
              >
                ...
                <td className='px-6 py-4 text-gray-600'>
                  <span
                    className={`capitalize px-3 py-1 text-xs font-medium rounded-full ${getScoreClass(
                      result.score,
                      result.status,
                    )}`}
                  >
